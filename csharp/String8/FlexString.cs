...
public class FlexString : IComparable<FlexString>, IEquatable<FlexString>
{
    ...
    public static bool IsNullOrEmpty(FlexString value)
    {
        ...
        return value._isString8Available ? value._string8.IsEmpty : string.IsNullOrEmpty(value._string);
    }

    public static bool IsNull(FlexString value)
    {
        if (value == null) { return true; }
        return value._isStringAvailable ? value._string == null : false;
    }
    ...
    {
        if (this._isString8Available && other._isString8Available)
        {
            return this.String8.CompareTo(other.String8);
        }
        else
        {
            return string.CompareOrdinal(this.String, other.String);
        }
    }
