...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    internal partial class RunTable : Table<Run>
    {
        ...
        internal RunTable(SarifLogDatabase database) : base()
        {
            ...
            BaselineGuid = AddColumn(nameof(BaselineGuid), ColumnFactory.Build<string>());
            RedactionTokens = AddColumn(nameof(RedactionTokens), ColumnFactory.Build<IList<string>>());
            DefaultEncoding = AddColumn(nameof(DefaultEncoding), ColumnFactory.Build<string>());
            DefaultSourceLanguage = AddColumn(nameof(DefaultSourceLanguage), ColumnFactory.Build<string>());
            NewlineSequences = AddColumn(nameof(NewlineSequences), ColumnFactory.Build<IList<string>>());
