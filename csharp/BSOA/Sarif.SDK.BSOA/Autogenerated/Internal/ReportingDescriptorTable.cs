...
namespace Microsoft.CodeAnalysis.Sarif
{
    ...
    internal partial class ReportingDescriptorTable : Table<ReportingDescriptor>
    {
        ...
        internal ReportingDescriptorTable(SarifLogDatabase database) : base()
        {
            ...
            DeprecatedIds = AddColumn(nameof(DeprecatedIds), ColumnFactory.Build<IList<string>>(default(IList<string>)));
            Guid = AddColumn(nameof(Guid), ColumnFactory.Build<string>(default(string)));
            DeprecatedGuids = AddColumn(nameof(DeprecatedGuids), ColumnFactory.Build<IList<string>>(default(IList<string>)));
            Name = AddColumn(nameof(Name), ColumnFactory.Build<string>(default(string)));
            DeprecatedNames = AddColumn(nameof(DeprecatedNames), ColumnFactory.Build<IList<string>>(default(IList<string>)));
            ...
            MessageStrings = AddColumn(nameof(MessageStrings), ColumnFactory.Build<IDictionary<string, MultiformatMessageString>>(default(IDictionary<string, MultiformatMessageString>)));
            DefaultConfiguration = AddColumn(nameof(DefaultConfiguration), new RefColumn(nameof(SarifLogDatabase.ReportingConfiguration)));
            HelpUri = AddColumn(nameof(HelpUri), ColumnFactory.Build<Uri>(default(Uri)));
